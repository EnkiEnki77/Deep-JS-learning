...
const findAll = (value, array) => {
	...
	for(let i = 0; i < array.length; i++) {
		...
		}else if(typeof value == 'string' && value.trim() != "" && typeof array[i] != 'number' && !Object.is(-0, array[i])){
			if(value == array[i]){
				arr.push(array[i])
			}	
		}else if(typeof value == 'number' && !Object.is(NaN, value) && !Object.is(-0, value) && !Object.is(-Infinity, value) && !Object.is(-Infinity, value) && typeof array[i] == 'string' && array[i].trim() != ""){
			if(value == array[i]){
				arr.push(array[i])
			}	
		}
